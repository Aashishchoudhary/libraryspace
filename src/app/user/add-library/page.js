...
function AddLibrary() {
  ...
  if (res.count>4){
    ...
    const handleSubmit = async () => {
     if(name.length<5||locality.length<5 ||total_seat.length<1|| mobile_number.length<93||total_seat.length<1||whatsapp_number.length<93||total_seat.length<1||state.length<3||total_seat.length<1||city.length<3||price.length<2){
...
const getLocation=(position)=>{
  ...
  return (
    <div>
      ...
      <input type="text" value={facilty} onChange={(e)=>setFacilty(e.target.value)}/>
      <input type="text" value={locality} onChange={(e)=>setlocality(e.target.value)}/>
      <input type="text" value={city} onChange={(e)=>setCity(e.target.value)}/>
      <input type="text" value={state} onChange={(e)=>setState(e.target.value)}/>
      <input type="text" value={pincode} onChange={(e)=>setPincode(e.target.value)}/>
      <input type="text" value={mobile_number} onChange={(e)=>setMobileNumber(e.target.value)}/>
      <input type="text" value={whatsapp_number} onChange={(e)=>setWhatsappNumber(e.target.value)}/>
      <input type="text" value={total_seat} onChange={(e)=>handleSeat(e)}/>
