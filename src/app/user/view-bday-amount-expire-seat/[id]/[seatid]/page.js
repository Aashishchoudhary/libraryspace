...
function AddData({ params: { id, seatid } }) {
  ...
  const getData = async () => {
    try {
      const response = await axios.get(`${url}/amount-bday-expire-seat_view/${id}/${seatid}/`, {
        headers: {
...
setLoading(false);
  ...
  const deleteData = async () => {
    ...
    try {
      if (window.confirm("Do you really want to Delete?")) {
        await axios.delete(`${url}/amount-bday-expire-seat_view/${id}/${seatid}/`, {
          headers: {
            Accept: "application/json",
            "Content-Type": "multipart/form-data",
  ...
  const patchData = async () => {
    ...
    try {
      await axios.patch(`${url}/amount-bday-expire-seat_view/${id}/${seatid}/`, updateData, {
        headers: {
          Accept: "application/json",
          "Content-Type": "multipart/form-data",
